...
public class RDV {
    ...
    private String studentName; // Pour affichage dans le dashboard médecin

    public RDV() {}

    public RDV(int id, String motif, String description, LocalDate dateDemande,
               String statut, String compteRendu, String ordonnanceUrl,
               int etudiantId, int creneauId) {
        this.id = id;
        this.motif = motif;
