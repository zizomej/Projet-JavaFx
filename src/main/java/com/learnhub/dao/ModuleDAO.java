...
public class ModuleDAO {
    ...
    // Récupérer uniquement les modules d'un professeur
    ...
    // Compter les modules d'un professeur spécifique
    ...
    public void update(Module m) {
        ...
        try (Connection conn = DatabaseConnection.getInstance();
            ...
            ps.executeUpdate();
            System.out.println("✏️ Module modifié !");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
    ...
    public void delete(int id) throws SQLException {
        ...
        try (Connection conn = DatabaseConnection.getInstance();
            ...
            ps.setInt(1, id);
            ps.executeUpdate();
            System.out.println("🗑️ Module supprimé !");
        }
    }
}